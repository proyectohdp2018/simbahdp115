...
-- Schema simuladorbsim
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `simuladorbsim` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `simuladorbsim` ;
...
CREATE TABLE IF NOT EXISTS `simuladorbsim`.`simulacion_simulacioncostoproduccion` (
  ...
  `usuarioSim_id` VARCHAR(50) NULL DEFAULT NULL,
  `cosecha_id` INT(11) NULL DEFAULT NULL,
  `fechaSim` DATE NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `simulacion_simulacio_usuarioSim_id_5d006b36_fk_registro_` (`usuarioSim_id` ASC),
  ...
  CONSTRAINT `simulacion_simulacio_cosecha_id_6f43b143_fk_produccio`
    FOREIGN KEY (`cosecha_id`)
    REFERENCES `simuladorbsim`.`produccion_cosecha` (`id`),
  CONSTRAINT `simulacion_simulacio_usuarioSim_id_5d006b36_fk_registro_`
    FOREIGN KEY (`usuarioSim_id`)
    REFERENCES `simuladorbsim`.`registro_usuario` (`nombre`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
